...
export const getFakeMovie = (): IMovie => {
  return {
    name: randMovie(),
    posterImage: randImg(),
    previewImage: randImg(),
    backgroundImage: randImg(),
    backgroundColor: randHex(),
    description: randLines(),
    rating: randNumber({ min: 0.0, max: 5}),
    scoresCount: randNumber({min: 0, max: 100000}),
    ...
    runTime: randNumber({min: 30, max: 120}),
    genre: randWord(),
    released: randNumber({min: 2000, max: 2024}),
    id: randNumber(),
    isFavorite: randBoolean(),
    videoLink: randFilePath(),
    previewVideoLink: randFilePath()
  }
}
...
export const videoData = {
  ...
  "poster": `https://es31-server.appspot.com/wtw/static/film/preview/pulp-fiction.jpg`
};
